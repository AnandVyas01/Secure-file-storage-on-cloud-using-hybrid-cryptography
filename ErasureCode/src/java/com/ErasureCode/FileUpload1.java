      ...
      Connection con=null;
        ...
        try
        {
            ...
            File file=new File("C:/"+Username);
               ...
               File serverf1=new File("D:\\mini_project_servers"+server1);
               System.out.println("WWWWWWWWWWW Bhagwna"+server1);
               if(!(serverf1.exists()))
               {
                   serverf1.mkdir();
               }
                File serverf2=new File("D:/"+server2);
               System.out.println("WWWWWWWWWWW Bhagwan"+server2);
               if(!(serverf2.exists()))
               {
                   serverf2.mkdir();
               }
               ...
               System.out.println("WWWWWWWWWWW Bhagwan"+server3);
               if(!(serverf3.exists()))
               {
                   serverf3.mkdir();
               }
               ...
               System.out.println("WWWWWWWWWWW Bhagwan"+server4);
               if(!(serverf4.exists()))
               {
                   serverf4.mkdir();
               }
